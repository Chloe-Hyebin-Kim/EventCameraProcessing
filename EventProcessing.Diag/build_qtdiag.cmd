...
rem projects. If QTDIR is absent, try supported Qt 5 MSVC locations. Qt 5.3
rem predates VS 2019 and its official binary kits are not ABI-compatible here.
...
if not defined QT_ROOT (
    echo [qtDiag] ERROR: A supported Qt 5 MSVC x64 kit was not found.
    echo [qtDiag] Qt 5.3.1 is too old for this VS 2019/CMake project.
    echo [qtDiag] Install Qt 5.12 or newer, preferably Qt 5.15.2 msvc2019_64.
...
:unsupported_qt
echo [qtDiag] ERROR: Qt %QT_VERSION% is unsupported. Qt 5.12 or newer is required.
echo [qtDiag] Qt 5.15.2 msvc2019_64 is recommended for Visual Studio 2019.
exit /b 5
