...
set_target_properties(MetavisionSDK::base PROPERTIES
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/libmetavision_sdk_base.so.5.2.0"
  IMPORTED_SONAME_RELEASE "libmetavision_sdk_base.so.5"
  )

list(APPEND _cmake_import_check_targets MetavisionSDK::base )
list(APPEND _cmake_import_check_files_for_MetavisionSDK::base "${_IMPORT_PREFIX}/lib/libmetavision_sdk_base.so.5.2.0" )
