...
1. Qt 5.12 이상 MSVC x64 패키지를 설치한다. Visual Studio 2019에는 `Qt 5.15.2 msvc2019_64`을 권장한다. **Qt 5.3.1은 Visual Studio 2019보다 오래된 버전이며 이 프로젝트에서 지원하지 않는다.** 기존 Qt 5.3.1을 제거할 필요는 없고 Qt 5.15.2를 나란히 추가 설치하면 된다.
